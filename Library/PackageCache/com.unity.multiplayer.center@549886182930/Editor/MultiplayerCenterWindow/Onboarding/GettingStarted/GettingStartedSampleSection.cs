...
namespace Unity.Multiplayer.Center.Editor
{
    ...
    class GettingStartedSampleSection : OnboardingGUIProvider<GettingStartedSampleSection>, IDataSourceViewHashProvider
    {
        const string k_GettingStartedSampleDefinitions =
            "Packages/com.unity.multiplayer.center/Editor/MultiplayerCenterWindow/GettingStartedSamples.asset";

        const string k_GettingStartedSampleUxml =
            "Packages/com.unity.multiplayer.center/Editor/MultiplayerCenterWindow/UI/GettingStartedSamples.uxml";
        ...
        public override VisualElement CreateGUI()
        {
            ...
            m_SamplesList = AssetDatabase.LoadAssetAtPath<GettingStartedSamplesList>(k_GettingStartedSampleDefinitions);
            ...
            var assetTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(k_GettingStartedSampleUxml);
        ...
        void SetupProjectLinkWarning(VisualElement content)
        {
            ...
            _projectLinkWarning.text = L10n.Tr("This sample requires Unity Services. Link this project in Project Settings > Services before importing.");
            _projectLinkWarning.buttonText = L10n.Tr("Open Services Settings");
        ...
        void SetupInstallInteraction(VisualElement content)
        {
            ...
            {
                removeButton.tooltip = L10n.Tr("Remove Sample");
            ...
            {
                m_InstallButton.text = L10n.Tr(k_ReImportText);
                m_InstallButton.tooltip = L10n.Tr("Sample has been already imported.");
        ...
        void InstallSelectedSample()
        {
            ...
            m_InstallButton.text = L10n.Tr(k_ImportingText);
        ...
        {
            bool isEnabled = true;
#if !UNITY_MULTIPLAYER_ONBOARDING_V2
            isEnabled = false;
#else
            isEnabled = !string.IsNullOrWhiteSpace(SelectedGameGenre.SampleId);
#endif
