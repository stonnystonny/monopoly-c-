...
namespace Unity.Multiplayer.Center.Editor
{
        ...
        IDataSourceViewHashProvider
    {
        ...
        {
            m_Recommendations = AssetDatabase.LoadAssetAtPath<Recommendations>(
                "Packages/com.unity.multiplayer.center/Editor/MultiplayerCenterWindow/PackagesRecommendations.asset");
            ...
            m_Root = AssetDatabase
                .LoadAssetAtPath<VisualTreeAsset>(
                    "Packages/com.unity.multiplayer.center/Editor/MultiplayerCenterWindow/UI/Recommendations.uxml")
                .CloneTree();
        ...
        void ConfigureInstallButton(Button button, Button[] allButtons, List<string> packageList, System.Action<List<string>> clicked)
        {
            ...
            void DisableAfterClick()
            {
                foreach (var b in allButtons)
                    b.enabledSelf = false;
                button.text = L10n.Tr("Installing package(s)...");
        ...
        {
            var tooltipBuilder
                = new StringBuilder(L10n.Tr("Will install the latest version of all the following packages:"))
                    .AppendLine();
            foreach (var package in packageList)
            {
