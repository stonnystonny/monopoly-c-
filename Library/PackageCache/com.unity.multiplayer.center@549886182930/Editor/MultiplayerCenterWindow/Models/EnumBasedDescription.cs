...
namespace Unity.Multiplayer.Center.Editor
{
    ...
    /// This is a default Inspector that will disable the UI if the MultiplayerCenter package
    /// is not locally installed (i.e., considered in development mode)
    /// </summary>
    ...
    class EnumBasedEditor : UnityEditor.Editor
    {
        public override VisualElement CreateInspectorGUI()
        {
            ...
            inspector.SetEnabled(
                PackageInfo.FindForPackageName("com.unity.multiplayer.center")?.source ==
                PackageSource.Local);
            return inspector;
        }
    }
